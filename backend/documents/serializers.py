...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "name", "initials", "role", "is_active", "date_joined",
        ]
...
class CategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Categorie
        fields = [
            "id", "name", "nom", "slug", "description", "date_creation",
            "count", "documentCount",
        ]
...
class DocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Document
        fields = [
            "id", "name", "nom", "description", "fileUrl", "fichier",
            "type", "taille", "size", "date", "date_creation",
            "date_modification", "categorySlug", "categoryName", "texte_ocr",
        ]
        read_only_fields = [
            "name", "nom", "fileUrl", "fichier", "type", "taille", "size",
            "date", "date_creation", "date_modification", "categorySlug",
            "categoryName", "texte_ocr",
        ]
    ...
    def get_categorySlug(self, obj):
        return slugify(obj.categorie.nom)

    def get_categoryName(self, obj):
        return obj.categorie.nom

    def get_size(self, obj):
        value = obj.taille or 0
        if value < 1024:
            return f"{value} o"
        if value < 1024 * 1024:
        ...
        return f"{value / (1024 * 1024 * 1024):.2f} Go"
